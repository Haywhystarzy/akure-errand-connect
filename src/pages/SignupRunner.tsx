...
const SignupRunner = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    console.log('Starting runner signup process...');
    ...
    if (!formData.bio.trim()) {
      toast({
        title: "Missing Information",
        description: "Please tell us why you want to be an Errand Runner",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      console.log('Attempting to sign up runner...');
      ...
      const { data: authData, error: authError } = await supabase.auth.signUp({
        ...
        options: {
          ...
          emailRedirectTo: `${window.location.origin}/dashboard-runner`
        }
      });
      ...
      console.log('Runner signed up successfully:', authData.user?.id);
      ...
      if (authData.user) {
        ...
        console.log('Saving runner profile data...');
        ...
        console.log('Runner profile created successfully!');
      ...
      console.error('Runner signup error:', error);
    ...
    <div className="min-h-screen bg-gradient-to-br from-errand-50 via-white to-blue-50 py-8 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">You are signing up as an Errand Runner</h1>
          <p className="text-gray-600">Complete your registration to start earning money by running errands</p>
        </div>

        <Card className="border-0 shadow-xl">
          <CardHeader>
            <CardTitle>Runner Registration</CardTitle>
            <CardDescription>
              Fill out all required information to create your runner account
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Bio */}
              <div className="space-y-2">
                <Label htmlFor="bio">Why do you want to be an Errand Runner? *</Label>
                <Textarea
                  id="bio"
                  value={formData.bio}
                  onChange={(e) => setFormData({ ...formData, bio: e.target.value })}
                  placeholder="Tell us about yourself and why you want to run errands..."
                  rows={3}
                  required
                />
              </div>
              ...
              <Button type="submit" className="w-full" disabled={isLoading}>
                {isLoading ? 'Creating Account...' : 'Create Runner Account'}
              </Button>
